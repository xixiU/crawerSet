...
def azure():
    client = AzureOpenAI(
        api_key="4f7461255925448b9afe30828d8bfb16e",  
        api_version="2024-02-15-preview",
        azure_endpoint='https://mphasisailab.openai.azure.com/'
    )
